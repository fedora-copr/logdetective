...
if __name__ == "__main__":
    ...
    parse = argparse.ArgumentParser(
        "bumpver.py", description="Bump version of the logdetective project."
    )
    parse.add_argument(
        "-t", "--tag", action="store_true", dest="tag", help="Create also a git tag."
    )
    parse.add_argument(
        "--version",
        action="store",
        default=None,
        dest="version",
        help="""Set a specific version. Without this argument the
