...
def process_log(
    ...
    Args:
        ...
        prompt_manager (PromptManager): Prompt manager, with templates to use with LLM.
    ...
    """
    messages = [
        {"role": "system", "content": prompt_manager.default_system_prompt},
        {"role": "user", "content": prompt_manager.render_message_template(snippets=log)},
    ]
