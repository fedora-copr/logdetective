...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_analyze_request_metrics_endpoint'), 'analyze_request_metrics', ['endpoint'], unique=False)
    op.create_index(op.f('ix_analyze_request_metrics_request_received_at'), 'analyze_request_metrics', ['request_received_at'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_analyze_request_metrics_request_received_at'), table_name='analyze_request_metrics')
    op.drop_index(op.f('ix_analyze_request_metrics_endpoint'), table_name='analyze_request_metrics')
